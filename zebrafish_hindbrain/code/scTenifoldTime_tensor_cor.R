...
#### correlation method
res_small <- scTenifoldTime_tensor(dta_list = dta_list, time_vec = time_vec, method = "cor", nComp = 5, q = 0,
...
#### correlation method
res_large<- scTenifoldTime_tensor(dta_list = dta_list, time_vec = time_vec, method = "cor", nComp = 5, q = 0,
                                  K = 10, maxIter = 10000, maxError = 1e-5, thres = 0.05, ma_nDim = 30)
